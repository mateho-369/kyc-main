 ...
 * Support both /firebase-session and /firebase/session paths
 */
 ...
 *
 * REMOVED securityHeaders - it was undefined and causing crashes
 */
router.post('/firebase-claims', authenticateFirebaseToken, async (req, res) => {
  try {
    // Extract data from request body (validatedData was from firebase-validation middleware which doesn't exist)
    const { sharegramUserId, kycPermissions } = req.body;
